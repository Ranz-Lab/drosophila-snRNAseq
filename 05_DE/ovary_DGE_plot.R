# Differential Expression UpSet Plot - Ovary
# Hariyani et al., 2025
...
set_columns <- c("Oviduct","Ovarian Sheath Muscle","Stretch Cells","Terminal Corpus Luteum Cells",
                   "Choriogenic MBFCs Stage 14",
                   "Choriogenic MBFCs Stage 12","Vitellogenic MBFCs Stage 9-10A","Vitellogenic MBFCs Stage 8",
                   "Vitellogenic MBFCs Stage 7",
                   "Post-Mitotic Follicle Cells Stage 6","Mitotic Follicle Cells Stage 1-5","Early Follicle Cells",
                   "Follicle Stem Cells (FSC) / preFCs","Stalk & Polar Cells","Germline - Germarium 2b-3","Germline - Germarium 2a-2b","Germline - GSC / Germarium 1 and 2a"
